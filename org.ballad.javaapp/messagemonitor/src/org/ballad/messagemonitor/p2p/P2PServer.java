...
package org.ballad.messagemonitor.p2p;
...
public class P2PServer extends JFrame {
    ...
    Hashtable<String,InetSocketAddress> ht=new 
            Hashtable<String,InetSocketAddress>();
                ...
                try
                {
                    ...
                    while(true)
                    {
                        ...
                        if(flag==true)//此时说明客户端是来通报自己的服务器信息的
                        {
                            ...
                            ht.remove(deviceIp);
                            ht.put(deviceIp, new InetSocketAddress(peerIp,peerPort));
                            s.close();
                            System.out.println(flag+","+deviceIp+","+peerIp+","+peerPort);
                        }
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnStart, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE))
                        .addGap(23, 23, 23)
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            .addComponent(btnQuit, GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtPort, GroupLayout.PREFERRED_SIZE, 98, GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
    ...
    private void btnQuitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuitActionPerformed
         int choice=JOptionPane.showConfirmDialog(null,
                "关闭服务器后将导致P2P功能停止，这意味着任意时刻最多"
                + "只能有一台报文监视器收到来自某一台电信设备的信息！\n"
